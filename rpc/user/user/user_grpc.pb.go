...
const (
	...
	AdminUserService_AddUser_FullMethodName     = "/user.AdminUserService/AddUser"
	AdminUserService_UpdateUser_FullMethodName  = "/user.AdminUserService/UpdateUser"
	AdminUserService_DeleteUser_FullMethodName  = "/user.AdminUserService/DeleteUser"
)
...
func (c *adminUserServiceClient) AddUser(ctx context.Context, in *UserUpdateReq, opts ...grpc.CallOption) (*UserInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserInfo)
...
func (c *adminUserServiceClient) UpdateUser(ctx context.Context, in *UserUpdateReq, opts ...grpc.CallOption) (*UserInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserInfo)
...
func (c *adminUserServiceClient) DeleteUser(ctx context.Context, in *UserInfoReq, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type AdminUserServiceServer interface {
	GetUserInfo(context.Context, *GetUserInfoReq) (*GetUserInfoResp, error)
	UserList(context.Context, *UserListReq) (*UserListResp, error)
	AddUser(context.Context, *UserUpdateReq) (*UserInfo, error)
	UpdateUser(context.Context, *UserUpdateReq) (*UserInfo, error)
	DeleteUser(context.Context, *UserInfoReq) (*Empty, error)
...
func (UnimplementedAdminUserServiceServer) AddUser(context.Context, *UserUpdateReq) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddUser not implemented")
}
func (UnimplementedAdminUserServiceServer) UpdateUser(context.Context, *UserUpdateReq) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUser not implemented")
}
func (UnimplementedAdminUserServiceServer) DeleteUser(context.Context, *UserInfoReq) (*Empty, error) {
...
func _AdminUserService_AddUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminUserServiceServer).AddUser(ctx, req.(*UserUpdateReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdminUserService_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminUserServiceServer).UpdateUser(ctx, req.(*UserUpdateReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdminUserService_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminUserServiceServer).DeleteUser(ctx, req.(*UserInfoReq))
	}
	return interceptor(ctx, in, info, handler)
}
